...
class DataTransformation:
    ...
    def get_data_transformer_obj(cls)->Pipeline:
        """
        It initialises a KNNImputer object with the parameters specified in the training_pipeline.py file and returns 
    ...
    def initiate_data_transformation(self)->DataTransformationArtifact:
        ...
        try:
            ...
            save_object("final_models/preprocessing.pkl", preprocessor_obj, )
